...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['avatar'])) {
        ...
        if (move_uploaded_file($archivoTemporal, $rutaDestino)) {
            ...
            $sql = "INSERT INTO tbl_entrega (nombre, apellido, nomina, fecha, marca, numeroserie, puesto, departamento, avatar) 
            VALUES ('$nombre', '$apellido', '$nomina', '$fecha', '$marca', '$serie', '$puesto', '$departamento','$nombreArchivo')";
...
{
    $sql = "SELECT * FROM tbl_entrega ORDER BY id ASC";
