...
async function cargarDetalleEmpleado(idEmpleado) {
  try {
    ...
    if (response.status === 200) {
      ...
      const { nombre, apellido, nomina, fecha, marca, numeroserie, puesto, departamento, avatar } =
        response.data;
      ...
      ulDetalleEmpleado.innerHTML = ` 
        ...
        <li class="list-group-item"><b>Nomina:</b> 
       ...
       <li class="list-group-item"><b>Numero De Seria:</b> 
        ${numeroserie  ? numeroserie  : "No disponible"}
        </li>
        <li class="list-group-item"><b>Puesto:</b> 
        ${puesto ? puesto : "No disponible"}
        </li>
         <li class="list-group-item"><b>Departamento:</b> 
          ${departamento ? departamento : "No disponible"}
        </li>
         <li class="list-group-item"><b>Imagen:</b> ${avatarHTML}</li>
      `;
    } else {
