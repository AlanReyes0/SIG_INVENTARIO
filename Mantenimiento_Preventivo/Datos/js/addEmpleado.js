 ...
 */
async function modalRegistrarEmpleado(event) {
  try {
...
async function registrarEmpleado(event) {
  try {
    ...
    const response = await axios.post("Verificacion/acciones.php", formData);
    ...
    if (response.status === 200) {
      ...
      setTimeout(() => {
        ...
        toastr.success("¡El empleado se agrego correctamente!.");
      }, 600);
    } else {
