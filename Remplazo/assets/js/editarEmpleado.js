...
async function cargarDatosEmpleadoEditar(idEmpleado) {
  try {
    ...
    if (response.status === 200) {
      const { id, nombre, apellido, nomina, sexo, telefono, puesto, departamento, avatar } =
        response.data;

      console.log(id, nombre, apellido, nomina, sexo, telefono, puesto, departamento, avatar);
